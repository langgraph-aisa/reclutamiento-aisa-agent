# Gobierno de release JARVI RH 2.0.137

## Identidad y fuente única

La versión vigente es **JARVI RH 2.0.137**. `package.json` es la fuente canónica y `shared/release.ts` expone la constante consumida por la interfaz y las pruebas. El pie del menú administrativo presenta producto, versión, rama, hash corto, sincronización con `origin/main` y distribución de lenguajes calculada durante cada build.

### Alcance candidato 2.0.137

El release transforma «Plazas y formularios» en «Plazas y anuncios» con icono de mundo: una plaza administra múltiples formularios, unos construidos con la herramienta y otros importados desde Excel/CSV (`forms.importSpreadsheet`, migración `0018`). La importación toma la primera fila como preguntas, exige una columna de teléfono o WhatsApp, reconcilia o crea candidatos con el número como única fuente de relación y agrega respuestas a la postulación sin sobrescribir las existentes; la evaluación se recalcula para las postulaciones afectadas. `application_form_submissions` registra las participaciones por formulario, y la ficha del candidato, Revisión Humana y el chat de WhatsApp resumen esas participaciones con sus respuestas. El análisis ontológico, epistemológico y fenomenológico está en [ANALISIS_ONTOLOGICO_FORMULARIOS_2.0.137.md](ANALISIS_ONTOLOGICO_FORMULARIOS_2.0.137.md). Las capacidades de 2.0.136, 2.0.135 y 2.0.134 permanecen bajo regresión.
...
La especificación del release está en [PRUEBAS_CAJA_NEGRA_2.0.137.md](PRUEBAS_CAJA_NEGRA_2.0.137.md).

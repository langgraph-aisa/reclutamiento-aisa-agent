...
const entityPage: Record<string, string> = {
  ...
  knowledge_project: "/admin/mst-eir",
  knowledge_folder: "/admin/mst-eir",
  knowledge_file: "/admin/mst-eir",
...
function projectedAudit(row: AuditRow) {
  ...
  return {
    ...
    action: row.action,
    outcome,
    title: activityTitle(actorLabel, row.action, pagePath),
...
function projectedActivity(row: ActivityRow) {
  ...
  return {
    ...
    outcome: row.outcome,
    title: activityTitle(actorLabel, row.event_type, pagePath),
    summary: activitySummary({
      actorLabel,
      action: row.event_type,
      pagePath,

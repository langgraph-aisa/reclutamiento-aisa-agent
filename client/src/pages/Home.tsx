...
export default function Home() {
  ...
  const metrics = [{ label: "Postulaciones", value: stats.total, note: "Todas las plazas", icon: UsersRound, tone: "bg-sky-50 text-sky-700" }, { label: "En revisión", value: stats.enRevision, note: "Requieren atención", icon: ClipboardCheck, tone: "bg-amber-50 text-amber-700" }, { label: "Solicitar CV por WhatsApp", value: stats.calificados, note: "Acciones registradas", icon: Sparkles, tone: "bg-emerald-50 text-emerald-700" }, { label: "Entrevistas", value: stats.entrevistas, note: "En cualquier estado", icon: MessageCircle, tone: "bg-violet-50 text-violet-700" }];

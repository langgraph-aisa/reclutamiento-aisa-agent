...
function PublicOpportunityCard({ jobs, loading }: { jobs: PublishedJob[]; loading: boolean }) {
  ...
  return (
    <Card className="relative overflow-hidden rounded-[2rem] border-white/70 bg-primary text-primary-foreground shadow-lift dark:bg-neutral-950 dark:text-white">

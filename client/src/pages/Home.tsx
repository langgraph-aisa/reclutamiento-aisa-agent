...
function PublicOpportunityCard({ jobs, loading }: { jobs: PublishedJob[]; loading: boolean }) {
  ...
  return (
    <Card className="relative overflow-hidden rounded-[2rem] border-white/70 bg-primary text-primary-foreground shadow-lift dark:bg-[#0B2945] dark:text-white">
        ...
        {loading ? (
          ...
          <>
            ...
            <Link href={`/apply/${selectedJob.token}`}>
              <Button size="lg" className="w-full rounded-2xl bg-white text-[#0B2945] hover:bg-white/90">

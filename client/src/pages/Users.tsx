...
const empty = { id: undefined as number | undefined, active: true, name: "", email: "", role: "reclutador" as "admin" | "reclutador" | "project_admin" };

...
<h1 align="justify">Empleos de Energia Solar en Guatemala | Talento AISA · JARVI RH 2.0.120</h1><p></p>
...
<p></p>
<p align="left">
  <img src="https://img.shields.io/badge/JARVI%20RH-2.0.120-0b2d4b" alt="JARVI RH 2.0.120" />
...
- Los 20 títulos `h1` comparten blanco semántico en Dark Dimmed y Dark High Contrast.
- El encabezado jurídico deja de heredar el color oscuro destinado a controles teal.

Descripción: separa el rol visual de títulos respecto de `primary-foreground` y añade un oráculo sobre el CSS compilado para impedir regresiones de contraste.

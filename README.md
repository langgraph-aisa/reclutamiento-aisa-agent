...
<h1 align="justify">Empleos de Energia Solar en Guatemala | Talento AISA · JARVI RH 2.0.203</h1><p></p>
...
<p></p>
<p align="left">
  <img src="https://img.shields.io/badge/JARVI%20RH-2.0.203-0b2d4b" alt="JARVI RH 2.0.203" />
...
<p align="center">
  ...
  <br />
  <sub>Agente JARVI RH 2.0.203 de Talento AISA (IA Evaluadora).</sub>
</p>
...
- La costura pasa a ser por clave relativa y el backend de Google Drive queda implementado: resuelve cada clave contra la jerarquía `JARVI RH/<proyecto>/…`, con renovación del token y la misma semántica de escritura, lectura, medida y borrado que el backend local. Sin migración.
...
- Publicado el análisis de viabilidad de Google Drive como capa de custodia del RAG de proyectos y del candidato: separa la cadena en cuatro eslabones, valida el scope `drive.file` y propone la abstracción de almacenamiento. Release de gobierno y documentación, sin código.
...
- Salida estructurada neutra: OpenAI conserva la Responses API y DeepSeek usa Chat Completions con `json_object`; `deepseek-reasoner` se ancla a `deepseek-chat`. La voz y la transcripción siguen en OpenAI. Sin migración.

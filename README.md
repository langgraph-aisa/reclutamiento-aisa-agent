...
- Paneles plegables en la ficha de evaluación: los cinco bloques se pliegan por sección y la matriz queda a la vista.
...
- Se corrige el defecto que impedía encender el ciclo automático: el asiento de auditoría entregaba la clave de configuración al identificador de la traza.

...
<h1 align="justify">Empleos de Energia Solar en Guatemala | Talento AISA · JARVI RH 2.0.211</h1><p></p>
...
<p></p>
<p align="left">
  <img src="https://img.shields.io/badge/JARVI%20RH-2.0.211-0b2d4b" alt="JARVI RH 2.0.211" />
...
<p align="center">
  ...
  <br />
  <sub>Agente JARVI RH 2.0.211 de Talento AISA (IA Evaluadora).</sub>
</p>
...
- La clave local del asiento se vuelve inmutable en la base, de modo que el envío duplicado de la solicitud de CV queda impedido estructuralmente con su causa nombrada; la referencia del proveedor vive en `provider_message_id`.

### 19SEP2026 · JARVI RH 2.0.198

- La puerta de integración continua deja de fallar por azar: la aplicación de migraciones se serializa entre archivos de prueba, porque el rol es del clúster y dos bases de prueba distintas colisionaban. La carrera se verifica con `pnpm verify:migrations` —sin cerrojo se reprodujo en seis de diez rondas— y la defensa vive en el arnés, no en cada guarda.

### 19SEP2026 · JARVI RH 2.0.197

- El mensaje de la solicitud deja de enviarse dos veces: la confirmación del envío sobrescribía la clave local de idempotencia con la del proveedor, de modo que el asiento dejaba de encontrarse y cada intento posterior insertaba uno nuevo. La clave local es un hecho del artefacto y no se toca: nombrar el asiento con la referencia remota lo dejaba sin identidad.

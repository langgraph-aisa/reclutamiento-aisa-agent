...
<h1 align="justify">Empleos de Energia Solar en Guatemala | Talento AISA · JARVI RH 2.0.201</h1><p></p>
...
<p></p>
<p align="left">
  <img src="https://img.shields.io/badge/JARVI%20RH-2.0.201-0b2d4b" alt="JARVI RH 2.0.201" />
...
<p align="center">
  ...
  <br />
  <sub>Agente JARVI RH 2.0.201 de Talento AISA (IA Evaluadora).</sub>
</p>
...
- Queda publicado el análisis de viabilidad de Google Drive como capa de custodia del RAG de proyectos y del RAG del candidato: separa la ruptura de la cadena de custodia en cuatro eslabones, valida el scope `drive.file` y propone una abstracción de almacenamiento que conserva los métodos vigentes. Es un release de gobierno y documentación, sin migración ni cambio de código.

### 22SEP2026 · JARVI RH 2.0.200

- El agente estrena un segundo proveedor de IA, DeepSeek, con conmutación resiliente: el proveedor activo aporta sus dos credenciales —principal y respaldo— y, si ninguna responde, el secundario sustituye el razonamiento de texto. La capa vive en `server/agentProviders.ts` y la observabilidad asienta proveedor y ranura en cada intento.
- La salida estructurada se vuelve neutra: OpenAI conserva la Responses API y DeepSeek usa Chat Completions con `json_object`, validado con el mismo esquema. `deepseek-reasoner` no admite salida estructurada y se ancla a `deepseek-chat`.
- La transcripción y la voz no tienen equivalente en DeepSeek y conservan las credenciales de OpenAI; la hoja administrativa incorpora el switch de proveedor activo y deja en gris las credenciales del inactivo. Sin migración.

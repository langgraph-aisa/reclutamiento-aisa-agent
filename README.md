...
<h1 align="justify">Empleos de Energia Solar en Guatemala | Talento AISA · JARVI RH 2.0.149</h1><p></p>
...
<p></p>
<p align="left">
  <img src="https://img.shields.io/badge/JARVI%20RH-2.0.149-0b2d4b" alt="JARVI RH 2.0.149" />
...
<p align="center">
  ...
  <br />
  <sub>Agente JARVI RH 2.0.149 de Talento AISA (IA Evaluadora).</sub>
</p>
...
- La recepción lee el feed global una vez por ronda, lo distribuye por número y clasifica por reconciliación con los envíos propios, sin depender del bit `from_me`.
- Un registro fallido se respalda en `conversation_events`; la configuración detenida se advierte en la bitácora.

### 16SEP2026 · JARVI RH 2.0.148

- La auditoría de recepción valida configuración, endpoints, activación, mensajes y duplicados con consultas de solo lectura.

### 16SEP2026 · JARVI RH 2.0.147

- La rehidratación del historial ya no duplica mensajes: reconcilia por identificador del proveedor y los envíos confirmados adoptan la clave canónica.

### 16SEP2026 · JARVI RH 2.0.146

- La recepción recorre el catálogo por páginas de 200 con techo de 2.000 y ancla cada evento a la aplicación recibida.

### 16SEP2026 · JARVI RH 2.0.145

- Un solo script deja la base lista: `database/005_servicio_conversacional_listo.sql` reúne `0022`–`0024` con verificación autocertificada, idempotente y validado en PostgreSQL 17.

### 16SEP2026 · JARVI RH 2.0.144

- La activación conversacional se gobierna desde `Configuración › WhatsApp`; la migración `0024` la deja preactivada, sin variables de entorno, y cada interruptor queda auditado.

### 16SEP2026 · JARVI RH 2.0.143

- El administrador de endpoints declara por interruptor la capacidad, los consumidores y si es indispensable para el agente, con avisos al apagar cada uno.
...
### Fuentes primarias incorporadas en 2.0.149
